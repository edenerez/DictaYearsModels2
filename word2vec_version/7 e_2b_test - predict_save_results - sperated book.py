...
for year in year_thresholds:
    ...
    file_name = 'e2b_map_all_results_'+param2.pre_prefix_parameters+'_year_'+str(year)+'.p'
    ...
    file_name = 'e2b_map_all_results_'+param2.pre_prefix_parameters+'_year_'+str(previous_year)+'.p'
    if previous_year > 0:
